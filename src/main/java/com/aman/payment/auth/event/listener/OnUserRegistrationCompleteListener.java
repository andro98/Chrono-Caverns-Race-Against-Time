...
import com.aman.payment.auth.event.OnUserRegistrationCompleteEvent;
import com.aman.payment.auth.exception.MailSendException;
import com.aman.payment.auth.model.User;
import com.aman.payment.auth.service.impl.EmailVerificationTokenService;
...
public class OnUserRegistrationCompleteListener implements ApplicationListener<OnUserRegistrationCompleteEvent> {
    ...
    private void sendEmailVerification(OnUserRegistrationCompleteEvent event) {
        ...
        try {
            mailService.sendEmailVerification(emailConfirmationUrl, user, event.getPassword());
