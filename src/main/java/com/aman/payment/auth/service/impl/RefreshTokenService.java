...
import com.aman.payment.auth.repository.RefreshTokenRepository;
...
//        refreshToken.setToken(UtilCore.generateRandomUuid());
    ...
    public void deleteByCreatedBy(String username) {
        refreshTokenRepository.deleteByCreatedBy(username);
    }
    ...
    @Transactional
    public void unUthenticateOldTokensForUser(User user) {
