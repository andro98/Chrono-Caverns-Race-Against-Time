...
//  @PreAuthorize("hasRole('ADMIN')")
    ...
    public ResponseEntity<String> addSubServiceTier(@CurrentUser CustomUserDetails customUserDetails,
                                                    @Valid @RequestBody AddEditSubServiceTierRequest decryptAddEditSubServiceTierRequest) {

        AddEditSubServiceTierRequest addEditSubServiceTierRequest =
                decryptAddEditSubServiceTierRequest.decrypt(cryptoMngrAuthService);

        return ResponseEntity.ok(cryptoMngrAuthService.encrypt(
                lookupManagement.addSubServiceTier(customUserDetails.getUsername(), addEditSubServiceTierRequest).toString()));
    }
