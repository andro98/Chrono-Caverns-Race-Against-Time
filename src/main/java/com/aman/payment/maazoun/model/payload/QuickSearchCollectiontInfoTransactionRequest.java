...
public class QuickSearchCollectiontInfoTransactionRequest {
	...
	public QuickSearchCollectiontInfoTransactionRequest() {
	}

	public QuickSearchCollectiontInfoTransactionRequest(String pageNo, String pageSize, String sortBy,
