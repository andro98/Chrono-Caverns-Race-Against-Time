                                        ...
                                        <td class="tw-card-body"
                                            ...
                                            <h1 class="tw-h1"
                                               ...
                                               style="margin: 45px 0 5px; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                Username: ${userName} <br/> Password: ${password}</p>
                                            <p class=""
                                               style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                            <span style="font-weight: 400;">Thank you for joining <strong>AMAN Payment Passport Insurance App</strong>, an efficient and smart solution to manage your payments!</span><br/><br/><span
                                            ...
                                            <p class="tw-signoff"
                                               style="margin: 45px 0 5px; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                Our best, <br/> AMAN Payment Passport Insurance App team</p>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
